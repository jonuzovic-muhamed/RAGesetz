package com.jonuzovic.ragesetz.api.dao.impl;
...
import com.jonuzovic.ragesetz.api.dao.IDataAccessObject;
import com.jonuzovic.ragesetz.api.dao.IEmbeddingDataAccessObject;
import com.jonuzovic.ragesetz.api.model.Law;

@Repository("lawDao")
public class LawDaoImpl implements IEmbeddingDataAccessObject, IDataAccessObject {

	private final JdbcTemplate jdbcTemplate;
	private final IVectorConverter converter;
	private final RowMapper<Law> mapper;
	
	public LawDaoImpl(JdbcTemplate jdbcTemplate, IVectorConverter converter, RowMapper<Law> mapper) {
		super();
